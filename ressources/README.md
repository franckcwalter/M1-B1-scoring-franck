...
> Brief associé : **M1-B1**.
> Mode : individuel, présentiel lundi, 5 heures synchrone.
...
| ⭐ **Bonus** — recherche d'hyperparamètres automatisée + validation croisée | ~35 min | [`06_RechercheHyperparam_CV_essentiel.md`](./06_RechercheHyperparam_CV_essentiel.md) |

> ⭐ **Le mini-cours 06 est optionnel** — à attaquer si tu as bouclé le
> tronc avant 14h (mission étoile). Il automatise le réglage manuel du
> mini-cours 03 et le fait **proprement** (sans toucher au test). Le
...
[`Formation-SIMPLON-IA/ia-dev-id-parcours-m1-b1`](https://github.com/Formation-SIMPLON-IA/ia-dev-id-parcours-m1-b1).
...
4. **Demander en direct lundi** — tu es en présentiel-Discord, autant en
   profiter. N'attends pas d'être bloqué·e 30 min sur le même point.

**Garde-fou** : pas besoin de coder hors lundi 9h-17h. Si tu finis tronc
